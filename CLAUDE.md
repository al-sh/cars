...
- **Обновлять документацию при изменении требований** — если пользователь меняет или расширяет требования (лимиты, поведение, архитектуру), обязательно отразить изменения в соответствующих файлах из папки `requirements/`
